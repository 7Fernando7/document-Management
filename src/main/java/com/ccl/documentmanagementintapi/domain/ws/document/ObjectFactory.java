 ...
 * generated in the com.ccl.documentmanagementintapi.domain.ws.document package.
...
public class ObjectFactory {
    ...
    private final static QName _DocumentProcessRequest_QNAME = new QName("http://www.transfesa.com/processor/schema/document", "documentProcessRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ccl.documentmanagementintapi.domain.ws.document
     */
    ...
    /**
     * Create an instance of {@link DocumentProcessRequestType }
     */
    public DocumentProcessRequestType createDocumentProcessRequestType() {
        return new DocumentProcessRequestType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DocumentProcessRequestType }{@code >}
     *
     * @param value Java instance representing xml element's value.
     * @return the new instance of {@link JAXBElement }{@code <}{@link DocumentProcessRequestType }{@code >}
     */
    @XmlElementDecl(namespace = "http://www.transfesa.com/processor/schema/document", name = "documentProcessRequest")
    public JAXBElement<DocumentProcessRequestType> createDocumentProcessRequest(DocumentProcessRequestType value) {
        return new JAXBElement<DocumentProcessRequestType>(_DocumentProcessRequest_QNAME, DocumentProcessRequestType.class, null, value);
    }
