...
public interface AnubisDeleteDocumentMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "notificationData.operationType", constant = "DELETE_DOCUMENT"),
    ...
    @Mappings({
            @Mapping(target = "idScanvisioDocument", source = "document.messageReferenceNumber", nullValueCheckStrategy = NullValueCheckStrategy.ALWAYS, nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE),
