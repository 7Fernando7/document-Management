...
import com.ccl.documentmanagementintapi.domain.dtos.notification.document.delete.DeleteDocumentNotificationType;
...
public interface DeleteDocumentNotificationMapper {
    ...
    default void setContent(String idScanvisio, String scanvisioDsError, DocumentProcessRequestType documentProcessRequestType, @MappingTarget NotificationType notification) {
        notification.setContent(dNotificationTypeToDeleteDocumentNotificationType(idScanvisio, scanvisioDsError, documentProcessRequestType));
    }
    ...
    DeleteDocumentNotificationType dNotificationTypeToDeleteDocumentNotificationType(String idScanvisio, String scanvisioDsError, DocumentProcessRequestType documentProcessRequestType);

    @AfterMapping
    default void setDocumentDate(@MappingTarget DeleteDocumentNotificationType deleteDocumentNotification) {
        deleteDocumentNotification.getDocumentInfo().setDateTime(OffsetDateTime.now());
    }
}
