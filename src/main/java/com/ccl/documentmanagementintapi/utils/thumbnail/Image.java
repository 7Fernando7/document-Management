 ...
 * <h3>Thread Safety</h3>
 * The {@link Image} class is <strong>thread-safe</strong> (as all the methods
...
public class Image {
     ...
     * deprecated {@link java.awt.Image#getScaledInstance(int, int, int)} method in the
    ...
    public enum Method {
         ...
         * {@link Image#THRESHOLD_QUALITY_BALANCED} or
         * {@link Image#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
    ...
    public enum Mode {
         ...
         * <p>
         * See "Image Proportions" in the {@link Image} class description for
         * more detail.
         */
        AUTOMATIC,
        /**
    ...
    public static BufferedImage resize(BufferedImage src, Method scalingMethod,
        ...
        if (scalingMethod == Image.Method.AUTOMATIC)
        ...
        if (scalingMethod == Image.Method.SPEED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
        } else if (scalingMethod == Image.Method.BALANCED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_BILINEAR);
        } else if (scalingMethod == Image.Method.QUALITY
                || scalingMethod == Image.Method.ULTRA_QUALITY) {
            /*
     ...
     * {@link Image#DEBUG} is <code>true</code>; otherwise the VM will be
     ...
     * @see Image#LOG_PREFIX
     * @see Image#LOG_PREFIX_PROPERTY_NAME
     */
    protected static void log(int depth, String message, Object... params) {
        if (Image.DEBUG) {
            System.out.print(Image.LOG_PREFIX);
     ...
     * method utilizes the {@link Image#THRESHOLD_QUALITY_BALANCED} and
     * {@link Image#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
    ...
    protected static Method determineScalingMethod(int targetWidth,
        ...
        if (length <= Image.THRESHOLD_QUALITY_BALANCED)
            result = Method.QUALITY;
        else if (length <= Image.THRESHOLD_BALANCED_SPEED)
